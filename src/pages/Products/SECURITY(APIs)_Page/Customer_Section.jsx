    ...
    <section className="py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-20 text-start">
        ...
        <h2 className="text-3xl md:text-[40px] font-bold text-[#000000] mb-10">
          {data.heading}
          <span className="text-[20px] text-[#F44336]">{data.subtext}</span>
        </h2>
        ...
        ${index === data.features.length - 1 ? "lg:col-span-2" : ""}`}
            >
              {iconMap[item.icon]}
              <h3 className="mt-4 text-[24px] font-medium text-[#F44336]">{item.title}</h3>
